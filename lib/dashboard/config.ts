...
export const DASHBOARD_CONFIGS: Record<UserRole, DashboardConfig> = {
  ...
  PARTNER: {
    ...
    description: 'Gestión de referencias y comisiones',
    widgets: [
      {
        id: 'partner-earnings',
        type: 'stats',
        title: 'Mis Ganancias',
        gridArea: '1 / 1 / 2 / 2',
        config: { metrics: ['total', 'pending', 'paid'] },
      },
      {
        id: 'partner-chart',
        type: 'chart',
        ...
        gridArea: '1 / 2 / 2 / 3',
        config: { chartType: 'bar', period: '12m' },
      },
      {
        id: 'partner-referrals',
        type: 'referral-list',
        title: 'Mis Agencias Referidas',
        gridArea: '2 / 1 / 3 / 3',
      },
    ],
    layout: { columns: 2, rows: 2, gap: 'md' },
    navigation: [
      ...
      { label: 'Referencias', href: '/dashboard/partner/referencias', icon: 'Link' },
      { label: 'Comisiones', href: '/dashboard/partner/comisiones', icon: 'DollarSign' },
