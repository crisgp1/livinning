  ...
  const fetchTrackings = async () => {
    try {
      ...
      if (data.success && data.data && data.data.length > 0) {
        ...
        // Datos de ejemplo para consistencia con las otras páginas del dashboard
        const mockTrackings: ServiceTracking[] = [
          {
            _id: '1',
          ...
          },
          {
            ...
            metadata: {
              lastActivityAt: '2024-01-16T11:15:00Z',
          ...
          },
          {
            ...
            communications: {
              unreadByProvider: 0,
              lastMessageAt: '2024-01-10T16:00:00Z'
            },
            metadata: {
              lastActivityAt: '2024-01-10T16:30:00Z',
              createdAt: '2024-01-10T14:00:00Z'
            },
            estimatedCompletionDate: '2024-01-10T16:30:00Z'
          }
        ]
